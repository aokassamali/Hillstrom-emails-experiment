...
data:
  raw_dir: data/raw
  processed_path: data/processed/hillstrom_clean.csv
  input_csv: data/raw/hillstrom.csv
  id_col: customer_id
  arm_col: Segment
  arm_map:
    control:
...
Write-TextFile "$RepoPath\src\experiment_checks.py" @"
from __future__ import annotations
...
Write-TextFile "$RepoPath\src\estimation.py" @"
from __future__ import annotations
...
Write-TextFile "$RepoPath\tests\test_experiment_checks.py" @"
import pandas as pd
...
Write-TextFile "$RepoPath\tests\test_estimation.py" @"
import numpy as np
import pandas as pd
